...
@Component({
  selector: 'app-game-list-seguidos',
  templateUrl: './game-list-seguidos.component.html',
  styleUrls: ['./game-list-seguidos.component.scss']
})
export class GameListSeguidosComponent implements OnInit{
